...
func createSimappAndExport(
	...
	var gravity *app.App
	if height != -1 {
		gravity = app.New(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), encCfg, appOpts)

		if err := gravity.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		gravity = app.New(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), encCfg, appOpts)
	}
