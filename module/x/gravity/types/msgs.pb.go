...
func (m *MsgBatchSendToEthClaim) GetRewardRecipient() string {
	if m != nil {
...
func (m *MsgValsetUpdatedClaim) GetRewardDenom() string {
	if m != nil {
...
func (m *MsgValsetUpdatedClaim) GetRewardRecipient() string {
	if m != nil {
		return m.RewardRecipient
	}
	return ""
...
var fileDescriptor_2f8523f2f6feb451 = []byte{
	...
	,
}
...
func (m *MsgBatchSendToEthClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RewardRecipient) > 0 {
		...
		i = encodeVarintMsgs(dAtA, i, uint64(len(m.RewardRecipient)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Orchestrator) > 0 {
...
func (m *MsgValsetUpdatedClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RewardDenom) > 0 {
		...
		i = encodeVarintMsgs(dAtA, i, uint64(len(m.RewardDenom)))
		i--
		dAtA[i] = 0x32
	}
	{
