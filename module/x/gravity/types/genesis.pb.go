...
type Params struct {
	...
	Erc20ToDenomPermanentSwap ERC20ToDenom `protobuf:"bytes,20,opt,name=erc20_to_denom_permanent_swap,json=erc20ToDenomPermanentSwap,proto3" json:"erc20_to_denom_permanent_swap"`
	// the denom which must be use to pay fee for the send to cosmos / batch transactions.
	BatchFeeDenom string `protobuf:"bytes,21,opt,name=batch_fee_denom,json=batchFeeDenom,proto3" json:"batch_fee_denom,omitempty"`
}
...
func (m *Params) GetBatchFeeDenom() string {
	if m != nil {
		return m.BatchFeeDenom
	}
	return ""
}
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BatchFeeDenom) > 0 {
		i -= len(m.BatchFeeDenom)
		copy(dAtA[i:], m.BatchFeeDenom)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.BatchFeeDenom)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchFeeDenom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BatchFeeDenom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
