...
/// Gravity Bridge tools (arcbnbbt) provides tools for interacting with the Onomy Gravity bridge for Cosmos based blockchains.
#[derive(Parser)]
...
pub struct Opts {
    ...
    /// $HOME/.althea_arcbnbbt/
    #[arg(short, long)]
    pub home: Option<PathBuf>,
    /// Set the address prefix for the Cosmos chain
    #[arg(short, long, default_value = DEFAULT_ADDRESS_PREFIX)]
