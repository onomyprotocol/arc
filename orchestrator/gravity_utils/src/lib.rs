...
pub const GRAVITY_DENOM_PREFIX: &str = "avax";
...
pub const TEST_RUN_BLOCK_STIMULATOR: bool = true;
pub const TEST_DEFAULT_MINER_KEY: &str =
    "0xb1bab011e03a9862664706fc3bbaa1b16651528e5f0e7fbfcbfdd8be302a13e7";
pub const TEST_DEFAULT_ETH_NODE_ENDPOINT: &str = "http://localhost:8545/ext/bc/C/rpc";
...
pub const TESTS_BATCH_NUM_USERS: usize = 40;
